# Supabase E-Mail Template: Change Email Address

Kopiere den folgenden HTML-Code exakt in das Feld **"Body"** unter **Authentication > Email Templates > Change email address** in deinem Supabase Dashboard. 

Dieser Code verwendet dieselbe hoch-elegante Template-Struktur wie die Willkommens-Mail, passend für das Ändern der E-Mail-Adresse.
...
<head>
    ...
    <title>E-Mail-Adresse ändern - Zahnarztpraxis Dr. Maria Schmidt</title>
...
<tr>
    <td style="padding: 50px 34px; text-align: center;">
        ...
        <!-- Text -->
        <p>Sie haben angefordert, Ihre E-Mail-Adresse zu ändern.</p>

        <p>
            Bitte bestätigen Sie die Aktualisierung von<br>
        ...
        <div style="margin: 32px 0 26px 0;">
            <a href="{{ .ConfirmationURL }}" class="btn">Änderung bestätigen</a>
        </div>
