# Supabase E-Mail Template: Welcome / Confirm Signup

Kopiere den folgenden HTML-Code exakt in das Feld **"Body"** unter **Authentication > Email Templates > Confirm signup** in deinem Supabase Dashboard. 

Dieser Code verwendet den neuen, bereinigten, hoch-eleganten HTML-Ansatz.
...
<head>
    ...
    <title>Konto bestätigen - Zahnarztpraxis Dr. Maria Schmidt</title>
...
<tr>
    <td style="padding: 50px 34px; text-align: center;">
        ...
        <div style="margin: 32px 0 26px 0;">
            <a href="{{ .ConfirmationURL }}" class="btn">E-Mail bestätigen</a>
        </div>
        ...
        <p class="footer-text">
            ...
            Falls Sie sich nicht registriert haben, können Sie sie ignorieren.
        </p>
